...
* HTML의 기본 구조
  ...
  * ```text
    ...
    <html>
      <head></head> # 해당 html 문서의 정볼르 담고 있다.
...
* CSS : 스타일, 레이아웃 등을 통해 문서를 표시하는 방법을 지정하는 언어
...
* css 적용 우선 순위
  ...
  1. 중요도 : !important로 나타냄(0순위) / 디버깅이 어려울 수 있어 사용시 주의
...
* Box Model
  ...
  * box-sizing
    * content-box : defaulf값, 콘텐츠 영역의 크기
...
* CSS Display
  ...
  * inline-block
    * 컨텐츠 너비 만큼 공간을 차지
    * width, heigh, margin-top,margin-bottom을 지정 가능.
  * none : 공간을 없애 버림. 
